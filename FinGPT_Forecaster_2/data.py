...
finnhub_client = finnhub.Client(api_key=os.environ.get("cmjetd1r01qo8idm00e0cmjetd1r01qo8idm00eg"))
client = OpenAI(api_key=os.environ.get("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"))
