...
access_token = "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"
finnhub_client = finnhub.Client(api_key="cmjetd1r01qo8idm00e0cmjetd1r01qo8idm00eg")
...
# model = PeftModel.from_pretraine(
#     base_model,
